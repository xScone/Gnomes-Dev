...
namespace AnomalousDucks.Configuration {
    public class PluginConfig
    {
        ...
        //{
            //SpawnWeight = plugin.Config.Bind("MistEyes", "Spawn weight", 20,
                //"The spawn chance weight for MistEyes, relative to other existing enemies.\n" +
